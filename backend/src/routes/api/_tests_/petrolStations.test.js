...
//     await petrolstaion.save();

//     const fromDb = await mongoose.connection.db.collection('petrolstations').findOne({ _id: petrolstaion._id });
...
//     expect(fromDb.name).toBe('PetrolStaion2');
//     expect(fromDb.displayPicture).toBe('logo2.jpg');
